...
class Rectangle(Shape):
    ...
    def __init__(self, x, y, w, h):
        # TODO: Implement given the above arguments
        pass
...
class Square(Rectangle):
    ...
    def __init__(self, x, y, size):
        # TODO: Call the Rectangle (base class to Square) constructor
        pass
...
class CompoundShape(Shape):
    ...
    def __init__(self, shapes):
        # TODO: Implement. What is the easiest way to store an assortment of shapes?
        pass

    def paint(self, canvas):
        # TODO: Implement (Hint: implement Rectangle paint() first)
        pass
